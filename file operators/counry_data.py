...
total_number_of_countries = len(countries_data)
...
highest_population = max(countries_data,key=lambda c:c.get("population"))
print(highest_population)

# sort countries with  population:-

sorted_population = sorted(countries_data,key=lambda c:c.get("population"))
